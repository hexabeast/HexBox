...
public class Tools {
	...
	static boolean isFull(int id, int x)
	{
		if(AllBlocTypes.instance.getType(id).artificial)return true;
		if(AllBlocTypes.instance.getType(id).oldTexture)return (x >= AllBlocTypes.instance.oldFull && x < AllBlocTypes.instance.oldFull+3);
	...
	public static void checkItems()
	{
		...
		{
			Furniture chest = GameScreen.entities.furnitures.furnitureListAll.get(GameScreen.inventory.chestid);
