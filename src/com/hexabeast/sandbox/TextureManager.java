...
public class TextureManager {
	...
	public TextureManager() 
	{
		...
		empty = newTexture(Gdx.files.internal("empty.png"));
		...
		rain = newTexture(Gdx.files.internal("raindrop.png"));
		...
		cadre = newTexture(Gdx.files.internal("cadre.png"));
		...
		Bbody = newTexture(Gdx.files.internal("players/1bis/body.png"));
		
		joy = newTexture(Gdx.files.internal("menu/joystick.png"));
		blank = newTexture(Gdx.files.internal("blank.png"));
