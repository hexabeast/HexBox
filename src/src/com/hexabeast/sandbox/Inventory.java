...
public class Inventory {
	...
	public void abortTransition()
	{
		...
		if(precedentItemPosY >= 7 && (!chestopen || chestid!=precedentChestId))
		{
	...
	public void putinchest(int cchestid)
	{
		Furniture chest = GameScreen.entities.furnitures.furnitureListAll.get(cchestid);
