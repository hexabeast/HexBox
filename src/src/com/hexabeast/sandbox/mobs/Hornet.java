...
public class Hornet extends Mob{
	...
	{	
		...
		{
			int id = AllEntities.getItem(Tools.floor((x+width/2)/16), Tools.floor((y+height/2)/16))-Constants.chestlimit;
			...
			if(touched)
			{
				GameScreen.entities.mobs.mobListAll.get(id).damage(power, 0.5f, x+width/2, y+height/2);
			}
		}
	}
